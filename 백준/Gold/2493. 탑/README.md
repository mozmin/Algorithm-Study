...
- **이중 for 문 사용**
    - 문제 N은 500,000 이하 이므로 이중 for 문 사용시 시간 초과가 되버림
    - 이에 다른 자료 구조를 활용하여 문제를 풀어야 하지만 마땅한 해결책을 찾기 못함 -> 정답 코드 보며 '스텍' 활용

---

### 배운 점 & 보완할 점
- 스텍의 활용 방법에 대해서 알게 됨
- 문제마다 정의된 시간, 메모리 제한 등을 잘 살펴보고 해결하기 위한 자료 구조를 생각해 내야 함.
